...
public class PnlVentas1 extends javax.swing.JPanel {
    ...
    public void obtenerVentasRecientes() {
        ...
        System.out.println(listaDeVentas.toString());
        //Limpiar la tabla
    ...
    public void iniciarTablas() {
        ...
        th.setFont(new Font("Segoe UI", Font.BOLD, 15));
        th.setForeground(Color.WHITE);
        tblVentas.getTableHeader().setBackground(new Color(2, 62, 138));
    ...
    private void initComponents() {
        ...
        add(btnBuscar, new org.netbeans.lib.awtextra.AbsoluteConstraints(960, 30, 40, 40));
        ...
        add(btnEliminar, new org.netbeans.lib.awtextra.AbsoluteConstraints(1110, 30, 40, 40));
        ...
        add(btnModificar, new org.netbeans.lib.awtextra.AbsoluteConstraints(1060, 30, 40, 40));
        ...
        add(txtBuscar, new org.netbeans.lib.awtextra.AbsoluteConstraints(680, 30, 280, 40));
        ...
        add(btnVerTodos, new org.netbeans.lib.awtextra.AbsoluteConstraints(1010, 30, 40, 40));
        ...
        add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(870, 160, 90, 100));
        ...
        add(lblTotalTicket, new org.netbeans.lib.awtextra.AbsoluteConstraints(1090, 670, 50, 30));

        jLabel14.setFont(new java.awt.Font("Segoe UI", 0, 14)); // NOI18N
        jLabel14.setForeground(new java.awt.Color(64, 64, 64));
        jLabel14.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        jLabel14.setText("Descripción");
        add(jLabel14, new org.netbeans.lib.awtextra.AbsoluteConstraints(930, 340, 130, 30));
